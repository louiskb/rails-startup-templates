...
# 2. Existing app: Standalone - applying the shared template with an existing app (e.g. `rails app:template LOCATION=shared/image_processing.rb`).

# GUARD 1: Skip entire template if Image Processing is already installed.
